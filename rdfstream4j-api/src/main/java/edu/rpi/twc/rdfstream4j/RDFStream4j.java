...
/**
 * A collection of global flags which influence RDFStream4j's behavior
 *
 * @author Joshua Shinavier (http://fortytwo.net)
 */
public class RDFStream4j {

    // static variables for use by RDFStream4j implementations (including wrappers and proxies)
