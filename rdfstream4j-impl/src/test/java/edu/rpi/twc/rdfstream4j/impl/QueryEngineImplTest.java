package edu.rpi.twc.rdfstream4j.impl;
...
import edu.rpi.twc.rdfstream4j.etc.QueryEngineTestBase;
...
public class QueryEngineImplTest extends QueryEngineTestBase {
    ...
    public void testAddLubmQueries() throws Exception {
        ...
        for (String q : LUBM_QUERIES) {
            ...
            InputStream in = RDFStream4j.class.getResourceAsStream(name);
            try {
    ...
    public void testDistinct() throws Exception {
        ...
        */
        ...
        // There is no simple relationship between RDFStream4j's and MemoryStore's answers in the presence of loops.
        // RDFStream4j finds additional correct answers not produced by MemoryStore, but MemoryStore finds additional
        // answers in which statements are matched by more than one triple pattern.
        // RDFStream4j produces some such "pathological" answers as a by-product of query evaluation, but it does
    ...
    public void testReduced() throws Exception {
        long overflow = RDFStream4j.getReducedModifierCapacity();
        RDFStream4j.setReducedModifierCapacity(2);
        try {
            ...
            RDFStream4j.setReducedModifierCapacity(overflow);
        }
    }
...
//                loadQuery("simple-cycle.rq"));
    ...
    public void testFilters() throws Exception {
        ...
        // RDFStream4j inherits its filter function implementations from Sesame,
    ...
    */
    ...
    public void testQueryTime() throws Exception {
        ...
        endTime = System.currentTimeMillis();
        System.out.println("RDFStream4j query time: " + (endTime - startTime));
